        ...
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              children: [
                ListTile(
                  title: Text(radioButtonItem, style: const TextStyle(fontSize: 21, color: Colors.white70)),
                ),
                ListTile(
                  title: const Text('Recibe en casa', style: TextStyle(fontSize: 21, color: Colors.white70)),
                  leading: Radio(
                    value: 1,
                ...
                ListTile(
                  title: const Text('Recoger en tienda', style: TextStyle(fontSize: 21, color: Colors.white70)),
                  leading: Radio(
                    value: 2,
                    activeColor: const Color(0xffF4A53C),                    
                    groupValue: id,
